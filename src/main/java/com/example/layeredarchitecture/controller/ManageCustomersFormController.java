...
public class ManageCustomersFormController {
    ...
    private void loadAllCustomers() {
        ...
        try {
            ...
            CustomerDAOImpl customerDAO=new CustomerDAOImpl();
            ArrayList<CustomerDTO>allCudtomer=customerDAO.getAllCustomer();
            for (CustomerDTO c:allCudtomer) {
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            boolean isSaved = customerDAO.saveOnCustomer(customerDTO);
                if (isSaved){
                    new Alert(Alert.AlertType.CONFIRMATION,"save succes");
                }
            ...
            try {
                if (!existCustomer(id)) {
                 ...
                 customerDAO.customerUpdate(customerDTO);
               /* Connection connection = DBConnection.getDbConnection().getConnection();
